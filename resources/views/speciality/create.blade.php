  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
    		<form data-toggle="validator" action="{{ route('specialities.store') }}" method="POST" id="create-form">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            ...
            <textarea input="text" name="speciality_category_id" class="form-control" data-error="Please enter link speciality category." required></textarea>
            <div class="help-block with-errors"></div>
          </div>
  				<div class="form-group">
