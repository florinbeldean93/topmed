	...
	<div class="container">
		<div class="row">
		    <div class="col-lg-12 margin-tb">					
				...
				<button type="button" class="btn btn-default" data-toggle="modal" data-target="#create-item">Add Post</button>
		        </div>
		    </div>
		</div>
		<table class="table">
			<thead>
				...
				<th style="text-align: center; vertical-align: middle">Main Image</th>
