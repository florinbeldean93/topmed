...
<body>
	...
	<div class="container">
		...
		<!-- Create Item Modal -->
		@include('screeninglocation.create')
		<!-- End of create -->

		<!-- Edit Item Modal -->
		@include('screeninglocation.edit')
		<!-- End of edit -->
	...
	<script type="text/javascript">
		var url = "<?php echo route('screeninglocations.index')?>";
	</script>
	<script src="/js/screeninglocations.js"></script> 
	<!-- End of scripts -->
</body>
</html>