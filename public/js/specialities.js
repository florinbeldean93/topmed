...
function manageRow(data) {
    ...
    $.each( data, function( key, value ) {
        ...
        rows = rows + '<td>'+value.speciality_category_id+'</td>';
...
$("body").on("click",".edit-item",function(){
    ...
    var short = $(this).parent("td").prev("td").text();
    var image = $(this).parent("td").prev("td").text();
    var description = $(this).parent("td").prev("td").text();
    var location = $(this).parent("td").prev("td").text();
    var speciality = $(this).parent("td").prev("td").text();

    $("#edit-item").find("input[name='name']").val(name);
    $("#edit-item").find("input[name='short_description']").val(short);
    $("#edit-item").find("type[name='image']").val(image);
    $("#edit-item").find("input[name='description']").val(description);
    $("#edit-item").find("input[name='location_id']").val(location);
    $("#edit-item").find("input[name='speciality_category_id']").val(speciality);
