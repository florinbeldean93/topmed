...
function manageRow(data) {
	...
	$.each( data, function( key, value ) {
        ...
        rows = rows + '<td>'+value.timetable+'</td>';
...
$(".crud-submit").click(function(e){
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Location Created Successfully.', 'Success Alert');
    });
});
//------------------------End Create--------------------------------------------
...
$("body").on("click",".remove-item",function(){
    ...
    $.ajax({
        ...
        c_obj.remove();
        toastr.success('Location Deleted Successfully.', 'Success Alert');
        getPageData();
    });
});
//------------------------End remove--------------------------------------------
...
$("body").on("click",".edit-item",function(){
    ...
    var timetable = $(this).parent("td").prev("td").text();
    ...
    $("#edit-item").find("input[name='timetable']").val(timetable);
...
$(".crud-submit-edit").click(function(e){
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Location Updated Successfully.', 'Success Alert');
    });
//-----------------------End Updated--------------------------------------------
