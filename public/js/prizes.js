...
$(".crud-submit").click(function(e){
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Prize Created Successfully.', 'Success Alert');
    });
});
//------------------------End Create--------------------------------------------
...
$("body").on("click",".remove-item",function(){
    ...
    $.ajax({
        ...
        c_obj.remove();
        toastr.success('Prize Deleted Successfully.', 'Success Alert');
        getPageData();
    });
});
//------------------------End remove--------------------------------------------
...
$(".crud-submit-edit").click(function(e){
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Prize Updated Successfully.', 'Success Alert');
    });
//-----------------------End Updated--------------------------------------------
