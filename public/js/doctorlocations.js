...
$(".crud-submit").click(function(e){
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Location Added Successfully.', 'Success Alert');
    });
});
//------------------------End Create--------------------------------------------
...
$("body").on("click",".edit-item",function(){
    var id = $(this).parent("td").data('id');
    var doctor_id = $(this).parent("td").prev("td").prev("td").text();
    var location_id = $(this).parent("td").prev("td").text();

    $("#edit-item").find("input[name='doctor_id']").val(doctor_id);
