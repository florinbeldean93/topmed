...
function manageRow(data) {
	...
	$.each( data, function( key, value ) {
        ...
        rows = rows + '<td>'+value.subtitle+'</td>';
        rows = rows + '<td>'+value.link+'</td>';
        rows = rows + '<td>'+value.link_name+'</td>';
...
$(".crud-submit").click(function(e){
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Slide Created Successfully.', 'Success Alert');
    });
});
//------------------------End Create--------------------------------------------
...
$("body").on("click",".remove-item",function(){
    ...
    $.ajax({
        ...
        c_obj.remove();
        toastr.success('Slide Deleted Successfully.', 'Success Alert');
        getPageData();
    });
});
//------------------------End remove--------------------------------------------
...
$("body").on("click",".edit-item",function(){
    ...
    var subtitle = $(this).parent("td").prev("td").text();
    var link = $(this).parent("td").prev("td").text();
    var link_name = $(this).parent("td").prev("td").text();
    var image = $(this).parent("td").prev("td").text();

    $("#edit-item").find("input[name='title']").val(title);
    $("#edit-item").find("input[name='subtitle']").val(subtitle);
    $("#edit-item").find("input[name='link']").val(link);
    $("#edit-item").find("input[name='link_name']").val(link_name);
    $("#edit-item").find("input[name='image']").val(image);
...
$(".crud-submit-edit").click(function(e){
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Slide Updated Successfully.', 'Success Alert');
    });
//-----------------------End Updated--------------------------------------------
