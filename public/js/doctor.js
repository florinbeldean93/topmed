...
function manageRow(data) {
	...
	$.each( data, function( key, value ) {
        ...
        rows = rows + '<td>'+value.job_type+'</td>';
...
$(".crud-submit").click(function(e){
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Doctor Created Successfully.', 'Success Alert');
    });
});
//------------------------End Create--------------------------------------------
...
$("body").on("click",".remove-item",function(){
    ...
    $.ajax({
        ...
        c_obj.remove();
        toastr.success('Doctor Deleted Successfully.', 'Success Alert');
        getPageData();
    });
});
//------------------------End remove--------------------------------------------
...
$("body").on("click",".edit-item",function(){
    ...
    var job = $(this).parent("td").prev("td").text();

    $("#edit-item").find("input[name='name']").val(name);
    $("#edit-item").find("input[name='job_type']").val(job);
...
$(".crud-submit-edit").click(function(e){
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('Doctor Updated Successfully.', 'Success Alert');
    });
//-----------------------End Updated--------------------------------------------
